...
package id.ac.poliban.mi.reihan.droidcafewithsettingschallenge;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "id.ac.poliban.mi.reihan.droidcafewithsettingschallenge.extra.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Droid Cafe With Settings Challange Reihan");
